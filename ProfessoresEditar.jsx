...
export function ProfessoresEditar(){
    ...
    async function obterDadosFormulario(data) {
        ...
        try{
            ...
            console.log("Dados enviados:", data); // Mostra o que foi enviado para o backend
            console.log("Erro da API:", error.response?.data || error.message); // Mostra a resposta do backend
    ...
    return(
        ...
        <form className={estilos.loginForm} onSubmit={handleSubmit(obterDadosFormulario)}>
                ...
                <div className={estilos.campo}>
                    ...
                    <label className={estilos.icone}>
                        <img src={tipo_gestor} alt="escolher um tipo de user" />
